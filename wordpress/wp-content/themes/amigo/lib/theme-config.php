...
function amigo_configuration_i18n( $config ) {

	$strings = array(
		'background-color'		 => __( 'Background Color', 'amigo' ),
		'background-image'		 => __( 'Background Image', 'amigo' ),
		'no-repeat'				 => __( 'No Repeat', 'amigo' ),
		'repeat-all'			 => __( 'Repeat All', 'amigo' ),
		'repeat-x'				 => __( 'Repeat Horizontally', 'amigo' ),
		'repeat-y'				 => __( 'Repeat Vertically', 'amigo' ),
		'inherit'				 => __( 'Inherit', 'amigo' ),
		'background-repeat'		 => __( 'Background Repeat', 'amigo' ),
		'cover'					 => __( 'Cover', 'amigo' ),
		'contain'				 => __( 'Contain', 'amigo' ),
		'background-size'		 => __( 'Background Size', 'amigo' ),
		'fixed'					 => __( 'Fixed', 'amigo' ),
		'scroll'				 => __( 'Scroll', 'amigo' ),
		'background-attachment'	 => __( 'Background Attachment', 'amigo' ),
		'left-top'				 => __( 'Left Top', 'amigo' ),
		'left-center'			 => __( 'Left Center', 'amigo' ),
		'left-bottom'			 => __( 'Left Bottom', 'amigo' ),
		'right-top'				 => __( 'Right Top', 'amigo' ),
		'right-center'			 => __( 'Right Center', 'amigo' ),
		'right-bottom'			 => __( 'Right Bottom', 'amigo' ),
		'center-top'			 => __( 'Center Top', 'amigo' ),
		'center-center'			 => __( 'Center Center', 'amigo' ),
		'center-bottom'			 => __( 'Center Bottom', 'amigo' ),
		'background-position'	 => __( 'Background Position', 'amigo' ),
		'background-opacity'	 => __( 'Background Opacity', 'amigo' ),
		'ON'					 => __( 'ON', 'amigo' ),
		'OFF'					 => __( 'OFF', 'amigo' ),
		'all'					 => __( 'All', 'amigo' ),
		'cyrillic'				 => __( 'Cyrillic', 'amigo' ),
		'cyrillic-ext'			 => __( 'Cyrillic Extended', 'amigo' ),
		'devanagari'			 => __( 'Devanagari', 'amigo' ),
		'greek'					 => __( 'Greek', 'amigo' ),
		'greek-ext'				 => __( 'Greek Extended', 'amigo' ),
		'khmer'					 => __( 'Khmer', 'amigo' ),
		'latin'					 => __( 'Latin', 'amigo' ),
		'latin-ext'				 => __( 'Latin Extended', 'amigo' ),
		'vietnamese'			 => __( 'Vietnamese', 'amigo' ),
		'serif'					 => _x( 'Serif', 'font style', 'amigo' ),
		'sans-serif'			 => _x( 'Sans Serif', 'font style', 'amigo' ),
		'monospace'				 => _x( 'Monospace', 'font style', 'amigo' ),
	);
...
add_filter( 'kirki/config', 'amigo_configuration_i18n' );
